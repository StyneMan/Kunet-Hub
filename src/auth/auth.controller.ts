...
export class AuthController {
  ...
  async signupCustomer(@Body() body: RegisterCustomerDTO) {
    return this.authService.createCustomer(body);
  }
  ...
  async sendOTPCustomer(@Body() payload: SendOTPDTO) {
    return this.authService.resendOTPCustomer(payload);
  }
  ...
  async sendPasswordResetEmailCustomer(@Body() payload: SendOTPDTO) {
    return this.authService.sendPasswordResetEmailCustomer(
  ...
  async resetPasswordCustomer(@Body() payload: ResetPasswordAdminDTO) {
    return this.authService.resetPasswordCustomer(payload);
  }
  ...
  async loginOperator(@Body() body: LoginCustomerDTO) {
  ...
  async sendOTPOperator(@Body() payload: SendOTPDTO) {
    return this.authService.resendOTPOperator(payload);
  }

  @Post('operator/verifyOTP')
  @UsePipes(
    new ValidationPipe({
      exceptionFactory: (errors: ValidationError[]) => {
        const validationErrors = errors.map((error) => ({
  ...
  async resetPasswordOperator(@Body() payload: ResetPasswordAdminDTO) {
    return this.authService.resetPasswordOperator(payload);
  }
  ...
  async loginRider(@Body() body: LoginRiderDTO) {
  ...
  async sendOTPRider(@Body() payload: SendOTPDTO) {
  ...
  async verifyOTPRider(@Body() payload: VerifyOTPDTO) {
    return this.authService.validateVerifyOTPRider(payload);
  }

  @Post('rider/forgotPassword')
  @UsePipes(
    new ValidationPipe({
      exceptionFactory: (errors: ValidationError[]) => {
        const validationErrors = errors.map((error) => ({
  ...
  async resetPasswordRider(@Body() payload: ResetPasswordAdminDTO) {
    return this.authService.resetPasswordRider(payload);
  }
}
